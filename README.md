...
# 23b2428 Goutam Singh , IIT BOMBAY DEMO LINK -https://drive.google.com/file/d/1OL_Yz3S_0qlk7k7piOPfmm0SPDV-voQD/view?usp=sharing
 The goal of this project is to fine-tune a pre-trained instruction-following model (phi-3-mini-4k-instruct) to reproduce a  writing style of the author ie me based on a limited set (75 samples) of text segments(will expand later).
